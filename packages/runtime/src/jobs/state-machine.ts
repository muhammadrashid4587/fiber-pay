...
const INVOICE_TRANSITIONS: Transition[] = [
  ...
  { from: ['executing', 'invoice_created', 'invoice_received'], event: 'payment_failed_permanent', to: 'failed' },
  {
    from: ['queued', 'executing', 'invoice_created', 'invoice_received'],
    event: 'cancel',
    to: 'cancelled',
  },
];
...
const CHANNEL_TRANSITIONS: Transition[] = [
  ...
  {
    from: ['queued', 'executing', 'channel_opening', 'channel_ready'],
    event: 'cancel',
    to: 'cancelled',
  },
];
